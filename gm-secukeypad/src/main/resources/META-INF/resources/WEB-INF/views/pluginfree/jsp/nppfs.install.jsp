...
//					document.form1.submit();
        ...
        function resize(event) {
            ...
            $("#nppfs-message-layer").css({"width": width + "px"}).css({
                "margin-left": (-1 * width / 2) + "px",
                "margin-top": (-1 * height / 3) + "px"
            });
        }
        ...
        <div class="nos-down">
            <div class="nos-down-multi">
                ...
                <div class="title">
                    ...
                    nProtect Online Security 설치 (<span class="nos-os-name">Windows 용</span>)
                </div>
                <div class="msg">
                    <ul>
                        <li> 접속PC정보 : <span class="nos-user-agent"></span></li>
                        <li> 하단의 다운로드 버튼을 눌러 프로그램을 다운로드 받아 설치 하시기 바랍니다.</li>
                        <li class="nos-hidden"> 설치 후 <a href="#" onclick="javascript:doStartInstall();return false;"><b>[접속확인]</b></a>을
                            하거나 해당사이트로 재 접속하여 주시기 바랍니다.
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="nos-down-msg">
                <ul>
                    <li>설치완료 후 장시간 화면이 멈춰있거나 설치가 반복될 경우 다음을 확인하시기 바랍니다.
                        <br>(1) 정상적인 설치/동작 확인을 위하여 <a href="#" onclick="javascript:doStartInstall();return false;"><b>접속확인</b></a>을
                        선택하여 정상적으로 접속되는지 확인합니다.
                        <br>(2) 접속확인시 "보안경고"가 발생하면 위험사항 확인 후 CA인증서를 설치하시기 바랍니다.
                    </li>
                    <li class="nos-windows">설치가 정상적으로 되지 않는 경우에는 사용중인 브라우저를 모두 종료한 뒤 [<span><b>제어판</b></span>]의
                        [<span><b>프로그램 추가제거</b></span>]에서 [<span><b>nProtect Online Security V1.0(PFS)</b></span>]를 삭제한
                        후에 수동설치 파일로 재설치 후 이용하십시오.
                    </li>
                    <li class="nos-macintosh">설치가 정상적으로 되지 않는 경우에는 사용중인 브라우저를 모두 종료한 뒤 [<span><b>Finder > 응용프로그램 > nProtect > nProtect Online Security V1 > NOS</b></span>]에서
                        [<span><b>nosuninst.app</b></span>]을 실행하여 삭제한 후에 수동설치 파일로 재설치 후 이용하십시오.
                    </li>
                    <li class="nos-linux">설치가 정상적으로 되지 않는 경우에는 사용중인 브라우저를 모두 종료한 뒤 [<span><b>터미널</b></span>]에서 [페도라 :
                        <span><b>sudo yum remove nprotect-online-security</b></span>, 우분투 : <span><b>sudo apt-get purge nprotect-online-security</b></span>]
                        명령을 수행하여 삭제한 후에 수동설치 파일로 재설치 후 이용하십시오.
                    </li>
                    <li>보안 프로그램 제품안내 : <b><a href="http://www.nprotect.com/v7/b2b/sub.html?mode=nos" target="__guide">[제품안내바로가기]</a></b>
                    </li>
...
<div id="nppfs-manual-download"
     style="display: none;  position: fixed; z-index: 10001; top: 50%; left: 50%; width:1px; height:1px; margin-top:20px;text-align:center;">
    <div class="nos-down-msg"
         style="position: relative; border-radius: 10px; max-width: 630px; border: 1px solid #666666; background-color:#ffffff;">
...
<div id="nppfs-message-layer"
     style="display: none;  position: fixed; z-index: 10001; top: 50%; left: 50%; width:1px; height:1px; text-align:center;">
    <div class="nos-down-msg"
        ...
        <div class="nos-down-btn">
            ...
            <button id="messageLayerCancelButton" type="button" style="width: 60px; height: 30px; display:none;">취소
            </button>
        </div>
    </div>
</div>
