...
public class KISA_SEED_CBC {
	...
	/**
	 * @param pbszUserKey    사용자가 지정하는 입력 키(16bytes), 암호화 대칭키
	 * @param pbszIV         사용자가 지정하는 초기화 벡터(16bytes), CBC 대칭키
	 * @param message        사용자 입력 평문 암호화할 문자열 byte
	 * @param message_offset 사용자 입력 길이 시작 오프셋(일단 0으로 입력)
	 * @param message_length 사용자 입력 길이, 암호화할 문자열 byte 의 길이
	 */
...
//                (byte)0x08, (byte)0x09, (byte)0x0A, (byte)0x0B, (byte)0x0C, (byte)0x0D, (byte)0x0E, (byte)0x0F};
		...
		System.out.print("[ Test Encrypt mode : ¹æ¹ý 1 ]" + "\n");
