...
public class D1400 extends BaseTime {
    ...
    @Column(columnDefinition = "varchar(1)    DEFAULT '' COMMENT '고위드기업등급'")
    ...
    @Column(columnDefinition = "varchar(15)    DEFAULT '' COMMENT '45일 평균잔고'")
    private String d030;  // 45일 평균잔고

    @Column(columnDefinition = "varchar(15)    DEFAULT '' COMMENT '45일 중간잔고'")
