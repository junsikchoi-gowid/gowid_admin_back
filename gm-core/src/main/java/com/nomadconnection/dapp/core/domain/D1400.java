...
public class D1400 extends BaseTime {
    ...
    @Column(columnDefinition = "varchar(13) comment '대표자주민등록번호'")
    private String d006; // 대표자주민등록번호
    @Column(columnDefinition = "varchar(50) comment '대표자명'")
    private String d007; // 대표자명
    @Column(columnDefinition = "varchar(13) comment '보증인고객식별번호'")
    private String d008; // 보증인고객식별번호
    @Column(columnDefinition = "varchar(50) comment '보증인고객한글명'")
    private String d009; // 보증인고객한글명
    @Column(columnDefinition = "varchar(15) comment '현재제휴한도'")
    private String d010; // 현재제휴한도
    @Column(columnDefinition = "varchar(6) comment '업종코드'")
    private String d011; // 업종코드
    @Column(columnDefinition = "varchar(6) comment '특화카드구분코드'")
    private String d012; // 특화카드구분코드
    @Column(columnDefinition = "varchar(2) comment '조건변경법인심사신청구분코드'")
    private String d013; // 조건변경법인심사신청구분코드
    @Column(columnDefinition = "varchar(15) comment '변경후제휴한도금액'")
    private String d014; // 변경후제휴한도금액
    @Column(columnDefinition = "varchar(8) comment '신청인사번'")
    private String d015; // 신청인사번
    @Column(columnDefinition = "varchar(8) comment '확인자사번'")
