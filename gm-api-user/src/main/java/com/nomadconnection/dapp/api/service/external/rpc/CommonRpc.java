    ...
    protected <T> T requestApi(String url, HttpMethod httpMethod,
        ...
        try {
            ...
            try {
                ...
                throw new SystemException(ErrorCode.External.EXTERNAL_ERROR_QUOTABOOK, ioException.getMessage());
            }
            throw new SystemException(ErrorCode.External.EXTERNAL_ERROR_QUOTABOOK, e.getMessage());

        } catch (Exception e) {
            log.error(e.getMessage(), e);
            throw new SystemException(ErrorCode.External.INTERNAL_ERROR_QUOTABOOK, e.getMessage());
        }
    }
