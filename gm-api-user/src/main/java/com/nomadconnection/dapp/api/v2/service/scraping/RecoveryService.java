...
public class RecoveryService {
	...
	@Transactional
	public void scrapByScrapingType(Long userIdx, ScrapingType scrapingType, String resClosingStandards, CardType cardType) throws Exception {
		User user = userService.getUser(userIdx);

		if(CORP_LICENSE.equals(scrapingType)){
			scrapingService.scrapCorpLicense(user, cardType);
		} else if (CORP_REGISTRATION.equals(scrapingType)) {
			scrapingService.scrapCorpRegistration(user, cardType);
