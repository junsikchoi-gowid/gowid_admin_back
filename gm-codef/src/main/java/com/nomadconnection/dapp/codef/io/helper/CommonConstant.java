...
public class CommonConstant {
	...
	public static final Integer[] SHINHAN_FILE = {1510,1520,1530,9991}; // 사업자등록증, 재무제표, 등기부등본, 기타서류
	public static final Integer[] LOTTE_FILE = {8502,8503,8505,8506}; // 사업자등록증, 재무제표, 등기부등본, 기타서류
